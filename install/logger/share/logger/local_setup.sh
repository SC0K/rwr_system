...
: ${AMENT_CURRENT_PREFIX:="/home/sitong/RWR_ros2_ws/src/rwr_system/install/logger"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/logger/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/logger/environment/path.sh"
